...
const App: React.FC = () => {
  ...
  const handleItemSelect = (item: SidebarType | WordSidebarType | ExcelSidebarType) => {
    if (item === SidebarType.Chat || item === SidebarType.Audit || item === SidebarType.Comment || item === ExcelSidebarType.ExcelDemo) {
  ...
  const renderContent = () => {
    ...
    switch (selectedItem) {
      ...
      case ExcelSidebarType.ExcelDemo:
        return <div style={{ padding: "20px" }}><h3>Excel 데모</h3><p>Excel 전용 데모 기능이 여기에 표시됩니다.</p></div>;
      default:
  ...
  return (
    <div style={{ height: "100vh", position: "relative" }}>
      ...
      <Sidebar
        ...
        hostItems={[ExcelSidebarType.ExcelDemo]}
